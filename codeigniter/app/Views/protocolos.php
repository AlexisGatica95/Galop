<div class="container">
    <h1 class="titulo-principal"><?=ucfirst(lang('App.posts.plural_protocolo'))?></h1>
    ...
    <?php foreach($protocolos as $post): ?>
        <div class="item">
            ...
            <a  class='btn btn-1 sm' href="<?=base_url()?>/<?=$locale?>/protocolos/<?=$post['slug']?>"><?=ucfirst(lang("App.noticia.ver_mas"))?></a>
        </div>
    <?php endforeach ?>
    </div>
    <?php echo $paginacion ?>
