<div class="container">
	<form id="form-reg" class="galop_form" enctype="multipart/form-data" action="" method="POST" autocomplete="off">
		<label class="full">
			<h3><?= lang('Admin.galop_form.crear_usuario'); ?></h3>
		</label>
		...
		<label for="permisos" class="">
			<span><?= lang('Admin.galop_form.permisos'); ?></span>
			<select name="permiso" id="sel_permisos">
				<option value="" disabled selected><?= lang('App.registro.option_seleccionar'); ?>...</option>
				<option value="1"><?= lang('Admin.galop_form.miembro'); ?></option>
				<option value="2"><?= lang('Admin.galop_form.administrador'); ?></option>
			</select>
		</label>

		<label for="consent_contacto" class="full">
			<input type="checkbox" name="consent_contacto" value="true">
			<span><?= lang('Admin.galop_form.span_permiso'); ?></span>
		</label>
