<div class="container">
	...
	<div class="content">
		<div class="about-left">
			<h3 class="subtitulo-principal"><?=ucfirst(lang("App.institucional.objetivos"))?></h3>
			<p>
		...
		<li>
			<a class="active" href="/<?=$locale?>/institucional/objetivos"><?=ucfirst(lang("App.institucional.objetivos"))?></a>
		</li>
		<li>
